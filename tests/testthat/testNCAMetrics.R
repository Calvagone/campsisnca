...
test_that("Dataset 1 - day 1 & day 7 - seed 1 & seed 2", {
  ...
  nca_d1_seed1 <- nca_d1_seed1 %>% calculate()
  ...
  nca_d7_seed1 <- nca_d7_seed1 %>% calculate()
  ...
  nca_d1_seed2 <- nca_d1_seed2 %>% calculate()
  ...
  nca_d7_seed2 <- nca_d7_seed2 %>% calculate()
