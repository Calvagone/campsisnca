...
test_that("Dataset 1 - day 1 & day 7", {
  ...
  nca_d1 <- nca_d1 %>% add(c(AUC(), Cmax(), Tmax(), Ctrough()))
  ...
  nca_d7 <- nca_d7 %>% add(c(AUC(), Cmax(), Tmax(), Ctrough()))
...
test_that("Dataset 1 - day 1 & day 7 - seed 1 & seed 2", {
  ...
  nca_d1_seed1 <- nca_d1_seed1 %>% add(c(AUC(), Cmax(), Tmax(), Ctrough()))
  ...
  nca_d7_seed1 <- nca_d7_seed1 %>% add(c(AUC(), Cmax(), Tmax(), Ctrough()))
  ...
  nca_d1_seed2 <- nca_d1_seed2 %>% add(c(AUC(), Cmax(), Tmax(), Ctrough()))
  ...
  nca_d7_seed2 <- nca_d7_seed2 %>% add(c(AUC(), Cmax(), Tmax(), Ctrough()))
