...
#' @param filter time range to use for filtering data
...
metricsParams <- function(variable=NULL, filter=NULL, name=NULL, unit=NULL, categorical=NULL, stat_display=NULL, digits=NULL) {
  # Do nothing
}
